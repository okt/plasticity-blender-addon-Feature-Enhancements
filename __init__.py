...
class RefacetPreset(bpy.types.PropertyGroup):
    name: bpy.props.StringProperty(name="Name", default="New Preset")
    
    # Basic settings
    tolerance: bpy.props.FloatProperty(name="Tolerance", default=0.01, min=0.0001, max=0.1, step=0.001, precision=6)                      
    angle: bpy.props.FloatProperty(name="Angle", default=0.45, min=0.1, max=1.0)
    
    # Advanced settings
    min_width: bpy.props.FloatProperty(name="Min Width", default=0.0, min=0, max=10, unit="LENGTH")    
    max_width: bpy.props.FloatProperty(name="Max Width", default=0.0, min=0.0001, max=1000.0, step=0.01, soft_min=0.02, precision=6, unit="LENGTH")
    Edge_chord_tolerance: bpy.props.FloatProperty(name="Edge chord tolerance", default=0.01, min=0.0001, step=0.01, max=1.0, precision=6)
    Edge_Angle_tolerance: bpy.props.FloatProperty(name="Edge Angle tolerance", default=0.45, min=0.1, max=1.0)
    Face_plane_tolerance: bpy.props.FloatProperty(name="Face plane tolerance", default=0.01, min=0.0001, step=0.01, max=1.0, precision=6)
    Face_Angle_tolerance: bpy.props.FloatProperty(name="Face Angle tolerance", default=0.45, min=0.1, max=1.0)     
